...
const usingArray = [`using`, `utilizing`, `with`];

const instrument = [
    `${randomStringFromArray(usingArray)} 5G technology`,
    `${randomStringFromArray(usingArray)} HAARP technology`,
    `${randomStringFromArray(usingArray)} Nazi gold`,
    `${randomStringFromArray(usingArray)} RFID chips`,
    `${randomStringFromArray(usingArray)} black helicopters`,
